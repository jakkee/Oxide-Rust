...
{
    [Info("BuildingRestriction", "Jakkee", "1.2", ResourceId = 2124)]
    class BuildingRestriction : RustPlugin
    {
        ...
        void UpdateDictionary()
        {
            ...
            Puts("Complete! Found " + buildingids.Count.ToString() + " structures");
        }
        ...
        {
            BasePlayer player = planner?.GetOwnerPlayer()?? null;
